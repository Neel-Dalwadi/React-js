    ...
    return (
        ...
        <div className='max-w-md mx-auto mt-10 p-6 border border-gray-300 rounded-lg shadow-lg'>
            <p className='mb-6 text-gray-700'> 
                Hello , my name is <span className='font-bold text-blue-500'>{firstName} {lastName}</span>.
                .my email is <span className='font-bold text-blue-500'>{email}</span> 
                ,my password is <span className='font-bold text-blue-500'>{password}</span> and my phone number is <span className='font-bold text-blue-500'>{phone}</span>.
            </p>
            <form 
